...
export const SEED_FLASHCARDS: Flashcard[] = [
  {
    ...
    "front": "憲法訴訟法第 59 條規定，人民聲請憲法法庭裁判之「除斥期間」與要件為何？",
  ...
  },
  {
    ...
    "front": "違憲審查中「嚴格審查基準（Strict Scrutiny）」之兩大要件為何？",
    "back": "① 目的要件：必須追求「特別重要或極重要之公共利益（Compelling Interest）」。\n② 手段要件：該手段必須是「達成目的所不可或缺且侵害最小（Narrowly Tailored）」之手段。",
  ...
  },
  {
    ...
    "front": "國家賠償法第 2 條第 2 項前段（過失侵權）與第 3 條（公共設施瑕疵）之歸責原則差異？",
    "back": "• 國賠 §2 II 前段（公務員行使公權力侵權）：採「主觀過失責任」原則（賠償機關對有故意或重大過失之公務員有求償權）。\n• 國賠 §3（公共設施設置管理欠缺）：採「客觀無過失責任」原則。",
  ...
  },
  {
    ...
    "front": "刑法第 23 條正當防衛與第 24 條緊急避難在「利益衡量」與「不法前提」之核心區別？",
    "back": "• 正當防衛：針對「現在不法侵害」，採「正對不正」，原則上不要求法益衡量（無庸避難優先）。\n• 緊急避難：針對「現在危難（包含天災或動物襲擊）」，採「正對正」，強制要求「法益衡量（保全法益必須大於侵害法益）」且符合補充性。",
  ...
  },
  {
    ...
    "subjectId": "CRIM",
    "chapterTitle": "沒收新制體系",
    "front": "刑法第 38 條之 1 犯罪所得沒收採「總額原則」還是「淨額原則」？成本是否扣除？",
    "back": "最高法院大法庭裁定：犯罪所得沒收採「總額原則（Gross Principle）」，犯罪行為人為實行犯罪所支出之犯罪成本（如買毒資金、作案工具），一律不得自犯罪所得中扣除！",
    "keyLawArticle": "刑法 §38-1",
    "tags": [
      "#刑法",
      "#沒收新制",
      "#大法庭見解"
  ...
  },
  {
    ...
    "back": "司法警察官拘提或逮捕被告時，僅得搜索「被告立即可觸及之處所、隨身攜帶物件及交通工具」；目的在於保護自身安全及防滅證，不得漫無限制搜索整棟房屋！",
  ...
  },
  {
    ...
    "front": "民法第 948 條及第 949 條盜贓物回復請求權之除斥期間為何？向善意有償取得人回復時有何特別限制？",
    "back": "• 占有人自「被盜或遺失之時起 2 年內」，得向占有人請求回復其物。\n• 若受讓人係「由拍賣、公共市場或販賣與其同種之物之商人處善意有償買得」者，被害人非償還其所付價金，不得請求回復！",
  ...
  },
  {
    ...
    "front": "民法第 821 條共有物返還之訴，於民事訴訟法上之共同訴訟性質與判決效力為何？",
  ...
  },
  {
    ...
    "back": "• 除丁類事件（監護宣告、死亡宣告）外，家事事件於起訴前應先經法院調解。\n• 家事調解成立並作成調解筆錄者，與「確定裁判具有同一之效力」（家事事件法 §30）。",
  ...
  },
  {
    ...
    "front": "證券交易法第 157 條之 1 內線交易之「消息沉澱期」為幾小時？規範之內部人範圍涵蓋哪些人？",
    "back": "• 消息沉澱期為：重大消息明確後，未公開前或「公開後 18 小時內」不得買賣。\n• 內部人包含：董監經理人、持有逾 10% 股份股東、基於職業關係獲悉之人、喪失身分未滿 6 個月者、及消息受領人。",
  ...
  },
  {
    ...
    "front": "當代國際法對國家主權管轄豁免採「絕對豁免主義」還是「限制豁免主義」？如何判斷？",
    "back": "當代國際法普遍採「限制豁免主義（Restrictive Immunity）」：\n• 主權行為（Jure Imperii，如軍事、外交）：享有豁免。\n• 商業交易行為（Jure Gestionis，如承租商業大樓、採購商用物資）：不享有管轄豁免！",
  ...
  {
    "id": "fc-PRIV_INT_LAW-1",
    "subjectId": "PRIV_INT_LAW",
    "chapterTitle": "涉外民事法律適用法契約與反致",
    "front": "涉外民事法律適用法第 20 條關於涉外契約準據法之決定順序為何？",
  ...
  },
  {
    ...
    "front": "律師法第 34 條規定律師「絕對禁止受任」之雙方代理與利益衝突情事有哪些？",
  ...
  },
  {
    ...
    "front": "英美法（Common Law）核心概念「Consideration」與「Stare Decisis」之中文定義與內涵？",
    "back": "• Consideration（約因/對價）：契約成立之核心要件，指當事人一方為換取對方承諾所付出之法律上有價利益或不利益。\n• Stare Decisis（遵循先例原則）：普通法系法院受本院或上級法院過去確定判決先例拘束之基本法理。",
    "keyLawArticle": "英美普通法核心原則",
    "tags": [
      "#法學英文",
      "#Consideration",
      "#StareDecisis"
